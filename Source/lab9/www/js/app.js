// Module Pattern, Constructor Pattern, Factory Pattern
...
function beerMetric( make, IBV, ABU ) {
  ...
  this.toString = function () {
    return this.make + " has done " + this.IBV + " IBV";
  };
}
 
var SamAdams = new beerMetric( "Samuel Adams", 15, 7 );
var Boulevard = new beerMetric( "Boulevard", 14, 8);

console.log( SamAdams.toString() );
console.log( Boulevard.toString() );

function beerFactory() {}
beerFactory.prototype.ABU = ABU;
 
beerFactory.prototype.ABU = function ( options ) {
